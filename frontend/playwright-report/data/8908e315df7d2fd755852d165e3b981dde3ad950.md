...
- Name: specs\contacts-crud.spec.ts >> Contact CRUD Flow >> create contact and verify it appears in list (onShow refresh)
- Location: tests\e2e\specs\contacts-crud.spec.ts:13:3
