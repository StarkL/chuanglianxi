...
- Name: specs\core-flow.spec.ts >> Core User Flow >> logout from mine page
- Location: tests\e2e\specs\core-flow.spec.ts:41:3
...
Call log:
  - waiting for locator('.uni-tabbar__label').filter({ hasText: '我的' })
