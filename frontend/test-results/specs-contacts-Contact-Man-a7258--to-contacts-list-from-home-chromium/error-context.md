...
- Name: specs\contacts.spec.ts >> Contact Management >> can navigate to contacts list from home
- Location: tests\e2e\specs\contacts.spec.ts:11:3
...
Call log:
  ...
  - waiting for getByText('联系人').first()
    9 × locator resolved to <div class="uni-tabbar__label">联系人</div>
